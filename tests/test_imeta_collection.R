...
# COLLECTION METADATA
avus <- NULL
expected_avus <- data.frame(Attribute="A", Value="V", Unit="U", stringsAsFactors = FALSE)

# imeta_ls
counters <- check_no_exception(name = "imeta_ls(<collection>) no exception",
                               expression = "avus <- imeta_ls('C', '/tempZone/UNIT_TESTING/EmptyCollection')",
                               counter = counters,
                               message = "This should not raise an exception"
)

counters <- check(name = "imeta_ls(<collection>) return type",
...
counters <- check(name = "imeta_ls(<collection>) output",
...
counters <- check_no_exception(name = "imeta_ls(<collection>, <data.frame>) after add no exception",
                               expression = "avus <- imeta_ls('C', '/tempZone/UNIT_TESTING/EmptyCollection')",
                               counter = counters,
                               message = "This should not raise an exception"
)
...
counters <- check(name = "imeta_ls(<collection>, <data.frame>) after add - output",
...
# imeta_rm(<data.frame>)
counters <- check_no_exception(name = "imeta_rm(<collection>, <data.frame>) after add - no exception",
                               expression = "imeta_rm('C', '/tempZone/UNIT_TESTING/EmptyCollection', avu_addition)",
                               counter = counters,
                               message = "This should not raise any exceptions"
)

counters <- check_no_exception(name = "imeta_ls(<collection>, <data.frame>) after rm no exception",
                               expression = "avus <- imeta_ls('C', '/tempZone/UNIT_TESTING/EmptyCollection')",
                               counter = counters,
                               message = "This should not raise an exception"
)
...
counters <- check(name = "imeta_ls(<collection>, <data.frame>) after rm - output",
                  condition = (identical(avus, expected_avus)),
                  counter = counters,
                  message = "Output does not correspond to expectation from fixtures"
)
...
counters <- check_no_exception(name = "imeta_ls(<collection>, <string>) after add no exception",
                               expression = "avus <- imeta_ls('C', '/tempZone/UNIT_TESTING/EmptyCollection')",
                               counter = counters,
                               message = "This should not raise an exception"
)
...
counters <- check(name = "imeta_ls(<collection>, <string>) after add - output",
                  condition = (identical(avus, expected_avus_add)),
                  counter = counters,
                  message = "Output does not correspond to expectation from fixtures"
)

# imeta_add(<collection>, <existing string>)
counters <- check_exception(name = "imeta_add(<collection>, <existing string>) - exception",
                               expression = "imeta_add('C', '/tempZone/UNIT_TESTING/EmptyCollection', avu_addition)",
                               counter = counters,
                               message = "This should raise an exception"
)
...
# imeta_rm(<string>)
counters <- check_no_exception(name = "imeta_rm(<collection>, <string>) after add - no exception",
                               expression = "imeta_rm('C', '/tempZone/UNIT_TESTING/EmptyCollection', avu_addition)",
                               counter = counters,
                               message = "This should not raise any exceptions"
)

counters <- check_no_exception(name = "imeta_ls(<collection>, <string>) after rm no exception",
                               expression = "avus <- imeta_ls('C', '/tempZone/UNIT_TESTING/EmptyCollection')",
                               counter = counters,
                               message = "This should not raise an exception"
)
...
counters <- check(name = "imeta_ls(<collection>, <string>) after rm - output",
                  condition = (identical(avus, expected_avus)),
                  counter = counters,
                  message = "Output does not correspond to expectation from fixtures"
)
